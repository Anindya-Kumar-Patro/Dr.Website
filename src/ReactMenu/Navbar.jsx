...
const Navbar = () => {
        ...
        <div className="container-fluid nav_bg">
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                     <NavLink className="navbar-brand" to="/">Dr.Website</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink exact activeClassName="menu_active" className="nav-link" to="/ecommerce">Medicines</NavLink>
        </li>
        <li className="nav-item">
          <NavLink exact activeClassName="menu_active" className="nav-link" to="/predict">Predict</NavLink>
        </li>
        <li className="nav-item">
